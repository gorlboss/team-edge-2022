...
def calulator():
  ...
  num1 = int(input("What is the first number do you want to operate on? "))
  num2 = int(input("What is the second number do you want to operate on? "))
  if operation == "x":
